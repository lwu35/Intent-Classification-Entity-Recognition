...
df_dev[['IOB Slot tags', 'Core Relations']].to_csv(
    'hw2_labels_dev.txt', sep='\t', header=None, index=None)
...
torch.save(quantized_model.state_dict(), 'q_bert_model.pt')
...
print('Inference time: BERT', end - start)
...
print('Inference time: Q_BERT', end - start)
